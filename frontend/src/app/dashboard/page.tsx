          ...
          <div className="lg:col-span-2">
            <div className="bg-white border border-sky-100 rounded-2xl shadow-sm">
              <div className="px-5 py-4 border-b border-sky-50 flex items-center justify-between">
                <h3 className="font-semibold text-gray-800">Estudios</h3>
                <button
              ...
              {studies.length === 0 ? (
                <div className="p-12 text-center">
                  ...
                  <p className="text-gray-400 text-sm mb-4">No hay estudios creados aún</p>
                  <button
                    onClick={() => router.push("/studies")}
                    className="px-5 py-2 bg-gradient-to-r from-sky-400 to-cyan-500 hover:from-sky-500 hover:to-cyan-600 text-white rounded-xl text-sm font-semibold transition-all shadow-sm"
                  >
